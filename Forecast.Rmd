...
runModel<-function(Yobs_dat,Ynew_dat){
  ...
  #Parameters to track
  ParsStage <- c("alpha","Ynew_pred","fitnew","Enew","detect")
  ...
  #MCMC options
    system.time(
      m2<-jags(data=Dat,parameters.to.save=ParsStage,inits=InitStage,model.file="models/SpeciesIdentity_Detect.jags",n.thin=1,n.iter=10,n.burnin=0,n.chains=2,DIC=F)
    )
    return(m2)
}
...
TODO: What about the species that aren't in the time series, can they be predicted by random encounter.
